          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div i-ri:earth-line${_scopeId2}></div><span${_scopeId2}>${ssrInterpolate(unref(t)("title.federated_timeline"))}</span>`);
                } else {
                  return [
                    createVNode("div", { "i-ri:earth-line": "" }),
                    createVNode("span", null, toDisplayString(unref(t)("title.federated_timeline")), 1)
                  ];
                }
              }),
              _: 1
